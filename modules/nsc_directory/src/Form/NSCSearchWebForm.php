...
class NSCSearchWebForm extends FormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state)
    {
        ...
        $form['collegeCode_options'] = array(
      //$form["collegeCode_options"] = array(
        '#type' => 'select',
        ...
        '#options' => [
          ...
          '063' => $this->t('NorthSeattle'),
          '064' => $this->t('SouthSeattle'),
          '065' => $this->t('SVI'),

          ],
          '#description' => 'College that you want to search',
    ...
    public function submitForm(array &$form, FormStateInterface $form_state)
    {
        ...
        //$collegeCode_options = $form_state->getValue('collegeCode_options');
        $college_code = $form_state->getValue('collegeCode_options');
        //$requestParams = array('CollegeCode' => '063'); //put in the code for SeattleCentral
        ...
        if (!empty($college_code)) {
          ...
          //switch case based on college code options value
          switch ($college_code) {
            ...
            case '061':
             ...
             default:
                echo "your college code options is not correct ";
              break;
         }
       }
